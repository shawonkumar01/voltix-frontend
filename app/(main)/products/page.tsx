                    ...
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 flex-1 max-w-md">
                            ...
                            <select
                                ...
                                className="hidden sm:block bg-white/[0.04] border border-white/[0.08] rounded-xl px-3 py-2 text-xs text-white/60 outline-none focus:border-cyan-400/40 transition-all cursor-pointer"
                            >
